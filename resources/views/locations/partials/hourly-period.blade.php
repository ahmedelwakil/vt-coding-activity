<article class="rounded-md border border-transparent bg-gray-100 dark:bg-gray-700 mx-2" style="width: 25%">
    ...
    <div class="flex flex-col p-2 text-center">
        <h3 class="text-lg font-semibold text-gray-900 dark:text-gray-100" aria-describedby="featureDescription">{{ \Carbon\Carbon::make($period['startTime'])->timezone('CDT')->dayName }}</h3>
        <h3 class="text-lg font-semibold text-gray-900 dark:text-gray-100" aria-describedby="featureDescription">{{ \Carbon\Carbon::make($period['startTime'])->timezone('CDT')->format('h:m a') }}</h3>
